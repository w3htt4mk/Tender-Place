...
import 'package:tender_place/page%202/mark4.dart';
import 'dart:ui';
...
class MarkScreen3 extends StatefulWidget {
  const MarkScreen3({Key? key}) : super(key: key);

  @override
  State<MarkScreen3> createState() => _MarkScreen3State();
}

class _MarkScreen3State extends State<MarkScreen3> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Более 10 лет организации мероприятий',
                style: SafeGoogleFont (
                  'Poppins',
                  fontSize: 20*ffem,
                  fontWeight: FontWeight.w500,
            ...
            InkWell(
              onTap: () {
                Navigator.pushAndRemoveUntil(context,
                    MaterialPageRoute(builder: (BuildContext context) => MarkScreen4()),
                    ModalRoute.withName('/')
                );
              },
              child: Container(
