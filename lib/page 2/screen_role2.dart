...
class ScreenRole2 extends StatelessWidget {
  const ScreenRole2({Key? key}) : super(key: key);
                  ...
                  children: [
                    InkWell(
                      ...
                      child: Container(
                        ...
                        height: 17.5*fem,
                        child: Image.asset(
                          'assets/page-3/images/back-LWv.png',
                          width: 26.38*fem,
                          height: 17.5*fem,
                        ),
                      ),
                                ...
                                Positioned(
                                  ...
                                  child: Align(
                                    child: SizedBox(
                                      ...
                                      height: 112*fem,
                                      child: Image.asset(
                                        'assets/page-3/images/mask-group.png',
                                        width: 105*fem,
                                        height: 112*fem,
                                      ),
                                    ),
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: Text(
                                        ...
                                        style: SafeGoogleFont (
                                          ...
                                          decorationColor: Color(0xff323142),
                                        ),
                                      ),
                                    ),
                                  ),
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          height: 28*fem,
                          child: Image.asset(
                            'assets/page-3/images/icon-32px-light-settings.png',
                            width: 28*fem,
                            height: 28*fem,
                          ),
                        ),
                        Container(
                          margin: EdgeInsets.fromLTRB(0*fem, 0.73*fem, 78.55*fem, 0*fem),
                          child: Text(
                            'Настройки профиля',
                            style: SafeGoogleFont (
                              'Poppins',
                        ...
                        Container(
                          ...
                          height: 12.25*fem,
                          child: Image.asset(
                            'assets/page-3/images/icon-24px-chevron-RfG.png',
                            width: 6.12*fem,
                            height: 12.25*fem,
                          ),
                        ),
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          height: 28.2*fem,
                          child: Image.asset(
                            'assets/page-3/images/icon-32px-light-lock.png',
                            width: 23.72*fem,
                            height: 28.2*fem,
                          ),
                        ),
                        ...
                        Container(
                          ...
                          height: 12.25*fem,
                          child: Image.asset(
                            'assets/page-3/images/icon-24px-chevron-MAS.png',
                            width: 6.12*fem,
                            height: 12.25*fem,
                          ),
                        ),
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          height: 28*fem,
                          child: Image.asset(
                            'assets/page-3/images/icon-32px-light-help.png',
                            width: 28*fem,
                            height: 28*fem,
                          ),
                        ),
                        ...
                        Container(
                          ...
                          height: 12.25*fem,
                          child: Image.asset(
                            'assets/page-3/images/icon-24px-chevron.png',
                            width: 6.12*fem,
                            height: 12.25*fem,
                          ),
                        ),
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              height: 32.66*fem,
                              child: Image.asset(
                                'assets/page-3/images/icon-rWW.png',
                                width: 31.58*fem,
                                height: 32.66*fem,
                              ),
                            ),
