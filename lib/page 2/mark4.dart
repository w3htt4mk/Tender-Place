...
import 'package:tender_place/page%202/mark5.dart';
import 'dart:ui';
...
class MarkScreen4 extends StatefulWidget {
  const MarkScreen4({Key? key}) : super(key: key);

  @override
  State<MarkScreen4> createState() => _MarkScreen4State();
}

class _MarkScreen4State extends State<MarkScreen4> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Функциональные характеристики предлагаемых услуг',
                style: SafeGoogleFont (
                  'Poppins',
                  fontSize: 20*ffem,
            ...
            InkWell(
              onTap: () {
                Navigator.pushAndRemoveUntil(context,
                    MaterialPageRoute(builder: (BuildContext context) => MarkScreen5()),
                    ModalRoute.withName('/')
                );
              },
              child: Container(
