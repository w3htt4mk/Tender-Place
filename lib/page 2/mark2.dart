...
import 'package:tender_place/page%202/mark3.dart';
import 'dart:ui';
...
class MarkScreen2 extends StatefulWidget {
  const MarkScreen2({Key? key}) : super(key: key);

  @override
  State<MarkScreen2> createState() => _MarkScreen2State();
}

class _MarkScreen2State extends State<MarkScreen2> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Срок предоставления гарантии качества товаров',
                style: SafeGoogleFont (
                  'Poppins',
                  fontSize: 20*ffem,
            ...
            InkWell(
              onTap: () {
                Navigator.pushAndRemoveUntil(context,
                    MaterialPageRoute(builder: (BuildContext context) => MarkScreen3()),
                    ModalRoute.withName('/')
                );
              },
              child: Container(
